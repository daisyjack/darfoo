...
public class VideoView extends SurfaceView implements
        VideoMediaController.MyMediaPlayerControl{
    ...
    /**
     * 修改了onMeasure中的尺寸显示方式，if语句中是添加部分
     */
    @Override
...
//        		if(mVideoWidth * tempH > tempW * mVideoHeight) {
//        			tempH = tempW * mVideoHeight / mVideoWidth;
//        		} else if(mVideoWidth * tempH < tempW * mVideoHeight) {
//        			tempW = tempH * mVideoWidth / mVideoHeight;
//        		}
////        		mSizeRatio = (double)mVideoWidth / (double)mVideoHeight;
//        		hasRatio = true;
//        	}
...
//        }
    ...
    private void openVideo() {
        ...
        try {
            ...
            //开始播放前即显示控制条，欲不显示注释即可
            mMediaController.show();
            mMediaBufferingIndicator.setVisibility(View.VISIBLE);   //在播放视频之前，显示缓冲等待，开始播放之后，indicator将消失
    ...
    private OnCompletionListener mCompletionListener = new OnCompletionListener() {
        public void onCompletion(IMediaPlayer mp) {
            ...
            mOnPlayNextListener.playNextVideo();
    ...
    private OnErrorListener mErrorListener = new OnErrorListener() {
        public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (mOnErrorListener != null) {  //一般不调用
            ...
            if (getWindowToken() != null) {
                ...
                if(mOnCompletionListener != null) {  //一般不调用

                    mOnCompletionListener.onCompletion(mMediaPlayer);
                }

                ((VideoMediaController)mMediaController).showErrorInfo();
                /*Intent intent = new Intent();
                intent.setAction("show_error");
    ...
    public void setOnPlayNextListener(OnPlayNextListener l) {
        mOnPlayNextListener = l;
