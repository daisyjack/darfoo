...
import com.darfoo.mvplayer.utils.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.scrubber_control_normal_red);
    ...
    private final Bitmap thumbDisabledImage = BitmapFactory.decodeResource(getResources(),
            R.drawable.scrubber_control_disabled_red);
...
//    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        String maxLabel = MusicPlayerActivity.generateTime(Long.valueOf(String.valueOf(this.absoluteMaxValue)));
        ...
        if (!selectedValuesAreDefault) {
            ...
            String minText = MusicPlayerActivity.generateTime(Long.valueOf(String.valueOf(getSelectedMinValue())));
            String maxText = MusicPlayerActivity.generateTime(Long.valueOf(String.valueOf(getSelectedMaxValue())));
